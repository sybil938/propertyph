<div class="container">
    ...
    <form id="addPropertyHouse" method="post" action="{{ url('/properties/create') }}" enctype="multipart/form-data">    
        {{ csrf_field() }}
        ...
        <div class="row pb-5">
            <div class="col">
                ...
                <small class="pt-2">How would you like to market your house unit/s?</small>
            </div>    
            <div class="col"></div> 
        </div> 
