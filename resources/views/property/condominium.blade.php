<div class="container">
    ...
    <form id="addPropertyCondo" method="post" action="{{ url('/properties/create') }}" enctype="multipart/form-data">    
        {{ csrf_field() }}
        ...
        <div class="row pb-5">
            <div class="col">
                <label for="name">Condominium Name</label>
                <input type="text" name="name" class="form-control" value="">
                <small class="pt-2">How would you like to market your condo unit/s?</small>
            </div>    
            <div class="col"></div> 
        </div> 
        ...
        <div class="row pb-5">           
            ...
            <div class="col">
                <input type="hidden" name="type" value="condominium">
