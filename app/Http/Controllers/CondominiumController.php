...
class CondominiumController extends Controller
{
    ...
    public function condoView($id)
    {
        ...
        $link          = asset('/storage/condominium/'. $data->user_id);
    ...
    {           
        ...
        if($request->hasFile('images')){            
            ...
            foreach ($images as $img) {
                Storage::delete('public/condominium/'. $data->user_id .'/'. $img );
            }           
            ...
            foreach($request->file('images') as $image) {  
                ...
                $path = $image->storeAs("public/condominium/$userID", $fileNameToStore);  
        ...
        return redirect("/properties/condominium/$data->id/view");
    }
